        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (_, state) => CheckoutScreen(
              directOrderArgs: state.extra is DirectOrderArgs ? state.extra as DirectOrderArgs : null,
            ),
          ),
          GoRoute(
            path: Routes.orders,
          ...
          GoRoute(
            ...
            builder: (_, state) {
              ...
              return ReviewFormScreen(orderItem: item as dynamic); // Using dynamic to avoid importing OrderItem here, or I can import it.
            },
          ),
