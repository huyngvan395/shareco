      ...
      body: SafeArea(child: Column(children: [
        const Padding(
          ...
          child: Align(alignment: Alignment.centerLeft,
              child: Text('Create', style: TextStyle(color: Colors.white, fontSize: 26,
        ...
        const Padding(
          ...
          child: Align(alignment: Alignment.centerLeft,
              child: Text('Share your moment with the world',
        ...
        Expanded(child: Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            _Option(icon: Icons.videocam_rounded, label: 'Record Video',
                subtitle: 'Up to 10 min · Filters · Effects · Music',
                gradient: const [Color(0xFFFF2D55), Color(0xFFFF6535)],
                onTap: () => _openCamera(context)),
            const SizedBox(height: 14),
            _Option(icon: Icons.upload_rounded, label: 'Upload from Gallery',
                subtitle: 'MP4, MOV · Caption · Cover · Privacy',
                gradient: const [Color(0xFF6C63FF), Color(0xFF3D9BE9)],
                onTap: () => _openGallery(context)),
            const SizedBox(height: 14),
            _Option(icon: Icons.live_tv_rounded, label: 'Go LIVE',
                subtitle: 'Real-time stream · Gifts · Comments',
        ...
        Container(
          ...
          child: const Row(children: [
            ...
            SizedBox(width: 10),
            Expanded(child: Text('Tip: Post at peak hours (7–9 PM) for maximum reach.',
